...
export const ComponentsRoutes: Routes = [
  {
...

    {
      ...
      data: {
        title: 'Pagination',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Pagination'}]
      }
    }, 
    {
      path: 'accordion',
      ...
      data: {
        title: 'Accordion',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Accordion'}]
      }
    }, 
    {
      path: 'alert',
      ...
      data: {
        title: 'Alert',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Alert'}]
      }
    }, 
    {
      path: 'carousel',
      ...
      data: {
        title: 'Carousel',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Carousel'}]
      }
    },  
    {
      path: 'datepicker',
    ...
    }, 
    {
      ...
      data: {
        title: 'Dropdown',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Dropdown'}]
      }
    }, 
    {
      path: 'modal',
      ...
      data: {
        title: 'Modal',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Modal'}]
      }
    }, 
    {
      path: 'poptool',
      ...
      data: {
        ...
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Popover & Tooltip'}]
      }
    }, 
    {
      path: 'rating',
      ...
      data: {
        title: 'Rating',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Rating'}]
      }
    }, 
    {
      path: 'tabs',
    ...
    }, 
    {
      ...
      data: {
        title: 'Timepicker',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Timepicker'}]
      }
    },  
    {
      path: 'typehead',
      ...
      data: {
        title: 'Typehead',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Typehead'}]
      }
    },
    {
      path: 'buttons',
      ...
      data: {
        title: 'Button',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Button'}]
      }
    },
    {
      path: 'cards',
      ...
      data: {
        title: 'Card',
        urls: [{title: 'Dashboard',url: '/dashboard'},{title: 'Card'}]
      }
    }]
  }
];
